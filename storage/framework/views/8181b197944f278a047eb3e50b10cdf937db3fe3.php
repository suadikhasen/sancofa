...
<div class="row">
	<div class="col-md-3">
		<form method="get" action="<?php echo e(route('Sancofa.Setting.BookDailyReport')); ?>">
	...
	<div class="col-md-3">
		...
		<form method="get" action="<?php echo e(route('Sancofa.Setting.BookMonthlyReport')); ?>" >
			 <div class="form-group  mr-3">
					<label for="information"><b>select information: </b></label>
					<select class="form-control" name="information" id="information">
					 <option>newly registered book</option>
	...
	<div class="col-md-3">
		...
		<form method="get" action="<?php echo e(route('Sancofa.Setting.BookYearlyReport')); ?>" >
			 <div class="form-group  mr-3">
					<label for="information"><b>select information: </b></label>
					<select class="form-control" name="information" id="information">
					 <option>newly registered book</option>
...
<?php echo $__env->make('sancofa.extends.setting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sankofa/lampstack-7.3.11-0/apache2/htdocs/Sankofa/resources/views/sancofa/setting/report/generalbooks.blade.php ENDPATH**/ ?>
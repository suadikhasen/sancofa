	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="card card-block">
				...
				<form method="post" action="<?php echo e(route('Sancofa.Books.Update',['id'=>$book_info->book_id])); ?>">
					<?php echo csrf_field(); ?>
					<div class="card-body">
                      
                      <div class="form-group">
							<label for="id"><b>book id</b></label>
							<input type="text" name="id" placeholder="book id"  class="form-control" list="book_id_list" value="<?php echo e($book_info->book_id); ?>" disabled>
						...
						<div class="form-group">
							...
							<input type="text" name="name" placeholder="name of the book" autofocus="autofocus" required="required" class="form-control" list="name_list" value = "<?php echo e($book_info->book_name); ?>">
						...
						<div class="form-group">
							...
							<input type="text" name="author" placeholder="author" required="required" class="form-control" value = "<?php echo e($book_info->book_author); ?>" list="author_list">
						...
						<div class="form-group">
							...
							<input type="number" name="price" id="price" placeholder="price" required class="form-control" value = "<?php echo e($book_info->price); ?>">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="donate" id="donate" placeholder="book donater" required="required" class="form-control" list="donator_list" value = "<?php echo e($book_info->donator); ?>">
...
<?php echo $__env->make('sancofa.extends.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sankofa/lampstack-7.3.11-0/apache2/htdocs/Sankofa/resources/views/sancofa/books/edit.blade.php ENDPATH**/ ?>
...
class MonthlyPayment
{
	...
	{
	   $september_payment = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'september',$amount);
	   $october_payment   = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'october',$amount);
	   $november_payment  =  calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'november',$amount);
	   $december_payment  = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'december',$amount);
	   $january_payment   = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'january',$amount);
	   $february_payment  = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'february',$amount);
	   $march_payment     = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'march',$amount);
	   $april_payment     = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'april',$amount);
	   $may_payment       = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'may',$amount);
	   $june_payment      = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'june',$amount);
	   $july_payment      = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'july',$amount);
       $august_paymemt    = calculate_TotalMonthlyPayment_Of_Specfic_Month($year,'august',$amount);
